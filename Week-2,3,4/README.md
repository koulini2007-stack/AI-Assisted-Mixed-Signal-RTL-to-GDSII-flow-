...
This repository documents the implementation of an AI-assisted mixed-signal RTL-to-GDSII design flow for a 2:1 Analog Multiplexer (AMUX2_3V) using the SKY130 Process Design Kit (PDK) and the OpenLa[...]

The project was carried out as part of the **AI-Assisted Mixed Signal Physical Design Internship**. Instead of manually copying the reference repository, all required design files, configuration fi[...]
...
The floorplan, placement, and routing screenshots in this project appear visually similar due to the compact size of the mixed-signal design. The design consists of a small digital SPI controller[...]
...
The routing stage additionally includes completed signal routing and power distribution, while the floorplan and placement stages primarily show the die boundary, macro placement, and standard-ce[...]
...
This project demonstrates the successful implementation of an AI-assisted mixed-signal RTL-to-GDSII design flow using the SKY130 PDK and OpenLane. AI-generated RTL, LEF, Liberty, and configuratio[...]
